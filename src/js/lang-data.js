export const langArr = {
  ...
  techLaw: {
    en: 'Understanding of legislation',
    ua: 'Орієнтуюсь у законодавстві',
  },
  techDoc: {
    en: 'Document management',
    ua: 'Працюю з документами',
  },
  techOperations: {
    en: 'Understanding of credit operations',
    ua: 'Розуміюсь у кредитних операціях',
  },
  techAnalytic: {
    en: 'Analytical skills',
    ua: 'Маю аналітичні навики',
  },
  techTexts: {
    en: 'Professional text writing',
    ua: 'Пишу професійні тексти',
  },
  techPk: {
    en: 'Proficiency in computer skills',
    ua: 'Володію ПК',
  },
  techInet: {
    en: 'Using internet resources',
    ua: 'Використовую інтернет-ресурси',
  },
  soft: {
    en: 'Soft Skills',
    ua: 'Особисті якості',
  ...
  motivation: {
    ...
    ua: 'Надзвичайно самомотивована',
  },
  enthusiasm: {
    en: 'Enthusiasm and dedication',
    ua: 'Виконую завдання з ентузіазмом і відданістю',
  },
  details: {
    en: 'A pretty good eye for details',
    ua: 'Уважна до деталей',
  },
  improve: {
    en: 'Strive for improvement',
    ua: 'Прагну до вдосконалення',
  },
  responsible: {
    en: 'Responsible for own decisions',
    ua: 'Відповідальна за свої рішення',
  },
  priorities: {
    en: 'Set priorities',
    ua: 'Розставляю пріоритети',
  },
  creative: {
    en: 'Creative and vigorous',
    ua: 'Креативна та енергійна',
  },
  outgoing: {
    en: 'Outgoing',
    ua: 'Товариська, привітна',
  },
  languages: {
    en: 'Languages',
    ua: 'Знання мов',
